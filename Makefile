...
GO_MODULE := github.com/sdivyansh59/grpc-proto-repo-unary
...
##protoc --go_opt=module=udemy-grpc-1 --go_out=. ./proto/basic/*.proto
## ./proto/basic/first/*.proto ./proto/basic/second/*.proto ./proto/basic/jobsearch/*.proto
#
#GO_MODULE := github.com/sdivyansh59/grpc-proto-repo-unary
#
#.PHONY: protoc-go
